      ...
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <div class="form-group row">
            <div class="col-md-3">
              <div
                class="col-md-1"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'categories/apps.png', $CLICSHOPPING_Upgrade->getDef('heading_title'), '40', '40'); ?></div>
              <div
                class="col-md-11 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_Upgrade->getDef('heading_title'); ?></div>
            </div>

            <div
              class="col-md-2"><?php echo HTML::selectMenu('install_module_directory', $CLICSHOPPING_Github->getModuleDirectory(), $_POST['template_directory'], 'onchange="this.form.submit();"'); ?></div>
            <div
              class="col-md-2"><?php echo HTML::selectMenu('install_module_template_directory', $CLICSHOPPING_Github->getModuleTemplateDirectory(), $_POST['template_directory'], 'onchange="this.form.submit();"'); ?></div>
            <div
              class="col-md-2"><?php echo HTML::inputField('module_search', '', 'required id="search" placeholder="' . $CLICSHOPPING_Upgrade->getDef('text_search') . '"'); ?></div>
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              <div class="custom-control custom-radio custom-control-inline">
                <?php echo HTML::radioField('official', 'true', true, 'class="custom-control-input" id="official1" name="official1"'); ?>
                <label class="custom-control-label" for="official1"><?php echo $CLICSHOPPING_Products->getDef('text_official'); ?></label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <?php echo HTML::radioField('official', 'false', false, 'class="custom-control-input" id="official2" name="official2"'); ?>
                <label class="custom-control-label" for="official2"><?php echo $CLICSHOPPING_Products->getDef('text_community'); ?></label>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card-text">
            ...
            <div class="col-md-6 float-start">
              <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal"
                      data-bs-target="#myModal_<?php echo $i; ?>"><?php echo $CLICSHOPPING_Upgrade->getDef('button_more_infos'); ?></button>
              <!-- Modal -->
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <p><img
                          src="https://raw.github.com/ClicShoppingAddsOn/<?php echo $module_real_name; ?>/master/<?php echo $item->image; ?>"
                          alt="<?php echo $module_real_name; ?>" class="img-fluid"></img></p>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary"
                              data-bs-dismiss="modal"><?php echo $CLICSHOPPING_Upgrade->getDef('text_close'); ?></button>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <?php
                  ...
                  if ($local_version != -1) {
                    if ($installed_check === true) {
                      echo '<span class="text-align-end">' . HTML::button($CLICSHOPPING_Upgrade->getDef('button_setting'), null, $module, 'success', null, 'sm') . '</span>';
                    }
                  }
                ?>
              </div>
            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-header">
                  <span
                    class="col-md-1"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'header/logo_clicshopping.webp', '50', '50'); ?></span>
                  <span class="col-md-11"><a
                      href="<?php echo $link_html; ?>/archive/master.zip"><?php echo $module_real_name . ' - Github'; ?></a></span>
                </div>
                <div class="card-block">
                  <div class="row">
                    <div class="card-text">
                        ...
                        if (\is_array($result_module_real_name)) {
                          foreach ($result_module_real_name as $content) {
                            ...
                            if ($content_module_name == $module_real_name . '.json') {
                              ...
                              <div
                                class="col-md-12"><?php echo $CLICSHOPPING_Upgrade->getDef('text_server_version') . $current_version_github; ?></div>
                                  ...
                                  <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <p><img
                                            src="https://raw.github.com/ClicShoppingOfficialModulesV3/<?php echo $module_real_name; ?>/master/<?php echo $result_content_module->image; ?>"
                                            alt="<?php echo $module_real_name; ?>" class="img-fluid"></img></p>
                                      </div>
                                      <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
