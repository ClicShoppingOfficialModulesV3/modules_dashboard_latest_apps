  ...
  class Github
  {
    ...
    */
    private function getGithubCoreRepo()
    {
      ...
      https://github.com/repos/ClicShopping/ClicShopping_V3
      return $url;
    }
    ...
    */
    ...
    private function checkDirectoryOnlineUpdate()
    {
      ...
      if (!is_dir($this->cacheGithubTemp)) {
        iif (!mkdir($concurrentDirectory == $this->cacheGithubTemp, 0777, true) && !is_dir($concurrentDirectory)) {
          throw new \RuntimeException(sprintf('Directory "%s" was not created', $concurrentDirectory));
        }
        return true;
    ...
    {
      $module = array(
        array('id' => '0', 'text' => $this->app->getDef('text_select_module_fix')),
